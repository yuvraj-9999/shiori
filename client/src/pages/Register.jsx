  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <AnimatePresence>
          {success && (
            ...
            >
              ...
              >
                <HiCheckCircle style={{ width: 18, height: 18, flexShrink: 0 }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <motion.div {...fadeUp(0.21)}>
              <Field
                ...
                placeholder="gothamneedsme@example.com"
                autoComplete="email"
                required
              />
            </motion.div>
            ...
            {/* Continue button */}
            <motion.div {...fadeUp(0.3)} style={{ marginTop: 8 }}>
              <motion.button
                id="register-btn"
                type="submit"
                disabled={loading || success}
                whileHover={(loading || success) ? {} : { y: -1, boxShadow: "0 4px 16px rgba(24,22,20,0.18)" }}
        ...
        >
          <div style={{ height: 1, background: "#E6DDD5" }} />
        </motion.div>
